...
>**Plain language summary**: We deformed  several AZ31 specimens under different conditions to generate different microstructures and textures. Then, we led a series of _in situ_ EBSD heating experiments   to demonstrate that the local accumulation of dislocations (a crystallographic defect within a crystal structure induced during deformation) controls the growth of new grains free of deformation structures (i.e. static recrystallization). We established new microstructural proxies based on EBSD data to demonstrate this effect.  [Grab the PDF here if you're interested!](https://github.com/marcoalopez/marcoalopez.github.io/blob/master/docs/2020_MC_Lopez-Sanchez.pdf)
