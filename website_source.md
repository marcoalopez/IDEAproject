...
>**Plain language summary**: We led a series of _in situ_ heating experiments on AZ31 magnesium alloys after deformation under different conditions to demonstrate that the local accumulation of dislocations (a crystallographic defect or irregularity within a crystal structure induced during deformation) controls the growth of new grains free of deformation structures (i.e. static recrystallization).  Sounds interesting? [grab it here in PDF!](https://github.com/marcoalopez/marcoalopez.github.io/blob/master/docs/2020_MC_Lopez-Sanchez.pdf)
...
> **Plain language summary:** The average grain size and the grain size populations are some of the most used features to study the microstructure of rocks and in particular recrystallization. This paper provides  guidelines for determining average grain sizes and the best methods for determining confidence intervals in grain size studies. We concluded that the geometric mean and the confidence intervals for the geometric mean provide the best balance between efficiency and robustness (being the median the best alternative). Sounds interesting? [grab it here in PDF!](https://github.com/marcoalopez/marcoalopez.github.io/blob/master/docs/2020_JSG_SG_104042.pdf)
